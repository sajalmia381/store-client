...
import { JsonPipe, KeyValuePipe, NgClass, NgTemplateOutlet, TitleCasePipe } from '@angular/common';
...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, NgTemplateOutlet, JsonPipe, TitleCasePipe, KeyValuePipe, NgClass, MatIconModule, AsPrismModule],
