...
export const loadCategoriesSuccess = createAction(ADD_TODO, props<{ todos: Todo[] }>());
export const loadTodos = createAction(LOAD_TODOS);
export const addOneTodo = createAction(ADD_ONE_TODO, props<{ todo: Pick<Todo, 'title' | 'status'> }>());
export const addOneTodoSuccess = createAction(ADD_ONE_TODO_SUCCESS, props<{ todo: Todo }>());
