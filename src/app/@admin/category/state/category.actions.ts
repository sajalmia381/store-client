...
export const ADD_ONE_CATEGORY_SUCCESS = '[category] add one category success';
...
export const updateCategory = createAction(UPDATE_CATEGORY, props<{ _id: string; slug: string; payload: Pick<Category, 'name'> }>());
